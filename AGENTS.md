...
- After launching a Nautilus job, start a local `nohup` monitor loop that records job status, pod status, pod events, process status, persistent training-log tail, and checkpoint/output files at least once every 60 seconds
