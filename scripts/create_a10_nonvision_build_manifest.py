#!/usr/bin/env python3
"""Create the immutable non-vision four-A10 image identity."""
...
os.environ.setdefault("PERFSEER_LABELER_PROFILE", "native_a10_nonvision_4gpu_v1")
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "containers/a10-nonvision-4gpu-labeler/build-manifest.json",
    )
    parser.add_argument(
        "--image-identity",
        default="perfseer-v3-nrp-a10-nonvision-4gpu-labeler:local-candidate",
    )
    ...
    payload = {
        "version": "perfseer_v3_nrp_a10_nonvision_image_build_manifest_v1",
