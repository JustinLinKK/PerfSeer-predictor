#!/usr/bin/env python3
"""Create the immutable native-A10 image source/dependency identity."""
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "containers/a10-labeler/build-manifest.json")
    parser.add_argument("--image-identity", default="perfseer-v3-nrp-a10-labeler:local-candidate")
    ...
    payload = {
        "version": "perfseer_v3_nrp_a10_image_build_manifest_v1",
