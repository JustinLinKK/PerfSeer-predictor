#!/usr/bin/env python3
"""Create the immutable native-A10 speech-V2 image identity."""
...
os.environ.setdefault("PERFSEER_LABELER_PROFILE", "native_a10_speech_v2")
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=ROOT / "containers/a10-speech-v2-labeler/build-manifest.json",
    )
    parser.add_argument(
        "--image-identity",
        default="perfseer-v3-nrp-a10-speech-v2-labeler:local-candidate",
    )
    ...
    payload = {
        "version": "perfseer_v3_nrp_a10_speech_image_build_manifest_v2",
